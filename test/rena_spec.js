...
describe("Rena", function () {
	...
	describe("testing match", function () {
		...
		it("real", function () {
			expect(R.real().parse("0").attribute).toBe(0);
			expect(R.real().parse("765").attribute).toBe(765);
			expect(R.real().parse("76.5").attribute).toBe(76.5);
			expect(R.real().parse("0.765").attribute).toBe(0.765);
			expect(R.real().parse(".765").attribute).toBe(0.765);
			expect(R.real().parse("765e2").attribute).toBe(76500);
			expect(R.real().parse("765E2").attribute).toBe(76500);
			expect(R.real().parse("765e+2").attribute).toBe(76500);
			expect(R.real().parse("765e-2").attribute).toBe(7.65);
			expect(R.real().parse("765e+346").attribute).toBe(Infinity);
			expect(R.real().parse("765e-346").attribute).toBe(0);
			expect(R.real().parse("96a1")).toBeNull();
			expect(R.real().parse("96+1")).toBeNull();
			expect(R.real().parse("96-1")).toBeNull();
			expect(R.real().parse("a961")).toBeNull();
			expect(R.real().parse("765e+")).toBeNull();
			expect(R.real().parse("765e-")).toBeNull();
			expect(R.real(true).parse("765").attribute).toBe(765);
			expect(R.real(true).parse("76.5").attribute).toBe(76.5);
			expect(R.real(true).parse("0.765").attribute).toBe(0.765);
			expect(R.real(true).parse(".765").attribute).toBe(0.765);
			expect(R.real(true).parse("765e2").attribute).toBe(76500);
			expect(R.real(true).parse("765E2").attribute).toBe(76500);
			expect(R.real(true).parse("765e+2").attribute).toBe(76500);
			expect(R.real(true).parse("765e-2").attribute).toBe(7.65);
			expect(R.real(true).parse("765e+346").attribute).toBe(Infinity);
			expect(R.real(true).parse("765e-346").attribute).toBe(0);
			expect(R.real(true).parse("96a1")).toBeNull();
			expect(R.real(true).parse("96+1")).toBeNull();
			expect(R.real(true).parse("96-1")).toBeNull();
			expect(R.real(true).parse("a961")).toBeNull();
			expect(R.real(true).parse("765e+")).toBeNull();
			expect(R.real(true).parse("765e-")).toBeNull();
			expect(R.real(true).parse("+765").attribute).toBe(765);
			expect(R.real(true).parse("+76.5").attribute).toBe(76.5);
			expect(R.real(true).parse("+0.765").attribute).toBe(0.765);
